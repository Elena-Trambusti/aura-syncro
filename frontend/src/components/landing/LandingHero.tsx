      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div>
          ...
          >
            <Link
              to="/login"
              className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-neutral-950/90 backdrop-blur-md border border-[#C5A059]/40 w-[240px] py-4 text-[#C5A059] font-medium tracking-widest uppercase text-sm transition-all duration-300 hover:border-[#C5A059] hover:shadow-[0_0_15px_rgba(197,160,89,0.2)]"
            >
              <span>Accedi</span>
              <AuraIcon icon={ArrowRight} size="md" className="absolute right-6 group-hover:translate-x-1 transition-all duration-300" />
            </Link>
          </div>
        </div>
