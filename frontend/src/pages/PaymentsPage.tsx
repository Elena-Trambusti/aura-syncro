  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Pagamenti Digitali</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <p className="text-2xl font-black text-slate-800">{formatCurrency(data.mese.amount)}</p>
          <p className="text-xs text-slate-400 mt-1">{data.mese.count} transazioni</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <p className="text-2xl font-black text-slate-800">{formatCurrency(avgOrder)}</p>
          <p className="text-xs text-slate-400 mt-1">per ordine Stripe</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <p className="text-2xl font-black text-slate-800">{formatCurrency(data.totale.amount)}</p>
          <p className="text-xs text-slate-400 mt-1">{data.totale.count} ordini totali</p>
        </div>
      </div>
