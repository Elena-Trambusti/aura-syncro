    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-stone-900/55 rounded-2xl p-5 border border-stone-800/50 shadow-sm">
          ...
          <p className="text-2xl font-black text-stone-100">{formatCurrency(data.mese.amount)}</p>
        ...
        <div className="bg-stone-900/55 rounded-2xl p-5 border border-stone-800/50 shadow-sm">
          ...
          <p className="text-2xl font-black text-stone-100">{formatCurrency(avgOrder)}</p>
        ...
        <div className="bg-stone-900/55 rounded-2xl p-5 border border-stone-800/50 shadow-sm">
          ...
          <p className="text-2xl font-black text-stone-100">{formatCurrency(data.totale.amount)}</p>
